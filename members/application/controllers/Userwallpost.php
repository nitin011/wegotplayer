...
class Userwallpost extends CI_Controller {
	...
	{  
			...
			//$this->load->view("sidebar");
	  		$this->load->view("wallpost/wall_post_view",$user_data);
				        ...
				        <ul class="got_players_wall">
				        	<li class="got-pl-left">
				        		<div class="sqil-profile">
								 <img class="img_thumb" src="'.$dp_url.'" alt="Profile Image">
								</div>
				        	</li>
				...
				}else
				{
					...
					$data='<li id="comment_'.$comment_id.'">
								<div class="sqil-profile-mini">
									<img alt="'.$name.' profile pic"  src="'.$dp_url.'" alt="Profile Image" width="25px" height="25px">
								</div>
