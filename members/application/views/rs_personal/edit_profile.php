    ...
    <form id="form_validation" class="uk-form-stacked">
      ...
      <div class="uk-width-medium-1-2">
          <div class="uk-form-row">
              ...
              <input type="text" value="<?php if(isset($name1[1])){echo ucfirst($name1[1]); }?>" id="lname" name="lname" required class="md-input" />
          </div>

          <div class="uk-form-row">
              <label for="website">Website<span class="req">*</span></label>
              <input type="text" value="" id="website" name="website" required class="md-input" />
          </div>
          <div class="uk-form-row">
              <label for="team">Your Org / Team Name<span class="req">*</span></label>
              <input type="text" value="" id="team" name="team" required class="md-input" />
          </div>
          ...
          <div class="uk-form-row">
              ...
              <select name="coach_gender" id="coach_gender" required data-md-selectize>
                  <option selected="" value="">Select Coach Gender</option>
        ...
        <div class="uk-form-row">
            ...
            <select name="occupation" id="occupation" required data-md-selectize>
                ...
                <?php foreach ($occupation as  $value) {  ?>                                                                                                                            
                   <option value="<?php echo $value->occupationId; ?>"><?php echo $value->occupationName; ?></option>
              <?php } ?>
            </select>                                    
        </div>
      ...
      <div class="uk-form-row">
          <button type="button" id="submit" class="md-btn md-btn-primary">Submit</button>
      </div>
