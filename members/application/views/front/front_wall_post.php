	    ...
	    <div class="md-card">
	         ...
	         <div class="uk-grid" data-uk-grid-margin="">
	            ...
	            <div id="total_posts" style="display: none;"><?php echo $total_posts; ?></div>	                         
                 ...
                 <div id="loader_list" style="display:none;" class="uk-text-center uk-margin-top uk-margin-small-bottom uk-width-medium"><img src="http://adept-testing.com/wegot/images/loader.gif" alt="loading..."></div>
	        </div>
	    </div>
	    </div>
	</div>
...
$(document).ready(function(){
    ...
    $.post("<?php echo base_url();?>front_wall/fetchData/",
...
function CheckData() {
		...
		$.post("<?php echo base_url();?>front_wall/checkData/",
  ...
  function add_post() 
    {
             ...
             if (post_text == null || post_text == "") {                
				$('.uk-form-row .md-input-wrapper ').addClass('md-input-wrapper-danger ');
						...
						$('#loader').show();
			 	        var user_id   = '<?php print_r($user_id);?>';                        						
						$.post("<?php echo base_url();?>front_wall/add_parent_post/",
	...
	{						   
		...
		var user_id   = '<?php print_r($user_id);?>';
		$.post("<?php echo base_url();?>front_wall/delete_parent_post/",		
    ...
    { 
	    ...
	    if (post_text == null || post_text == "") {               
                ...
                return false;
			 	        ...
			 	        var user_id   = '<?php print_r($user_id);?>';						
						$.post("<?php echo base_url();?>front_wall/edit_parent_post/",
	...
	function add_comment(post_id)
	{
			...
			$('#comment_value_'+post_id).focus();
					...
					$.post("<?php echo base_url();?>front_wall/add_comment/",
	...
	{	 
		...
		var post_commenter_id   = '<?php print_r($user_id);?>';	
		$.post("<?php echo base_url();?>front_wall/delete_comment/",		
    ...
    { 
	    ...
	    if (comment_text == null || comment_text == "") {               
                ...
                return false;
						...
						$.post("<?php echo base_url();?>fornt_wall/edit_comment/",
