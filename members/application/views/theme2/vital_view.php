...
<!--  Start Vital Section -->
      ...
      <button type="button" id="add_tactical" class="glyphicon glyphicon-plus icon_pusbig_orange"></button>

<button type="button" id="add_physical" class="glyphicon glyphicon-plus icon_pusbig_orange"></button>


<button type="button" id="add_psychosocial" class="glyphicon glyphicon-plus icon_pusbig_orange"> </button>


  <button type="button" id="add_technical" class="glyphicon glyphicon-plus icon_pusbig_orange"> </button>