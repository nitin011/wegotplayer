...
class paypal_lib {
	...
	function paypal_auto_form() 
	{
		...
		echo '<p class="intro text-center">Please wait, your order is being processed and you will be redirected to the paypal website.</p>' . "\n";
	...
	function paypal_form($form_name='paypal_form') 
	{
		...
		//$str .= $this->submit_btn;
		$str .= '<input type="submit" name="submit" class="md-btn md-btn-primary adept-md-btn-primary" value="Confirm Now">';
		$str .= "</form>\n";
